...
export default function Register() {
  ...
  return (
    <div className="min-h-screen pt-20 flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="absolute top-1/3 right-1/4 w-[35rem] h-[35rem] bg-white/70/15 rounded-full mix-blend-screen filter blur-[120px] animate-blob" />
      <div className="absolute bottom-1/4 left-1/4 w-[25rem] h-[25rem] bg-white/50/15 rounded-full mix-blend-screen filter blur-[100px] animate-blob animate-blob-delay" />
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in py-12">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-white mb-2 font-['Syne']">Join the Vibe</h2>
          <p className="text-slate-400">Create your account to start discovering events.</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-[2rem] border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-4 py-3.5 text-white placeholder-slate-500 focus:outline-none focus:border-white/50 focus:ring-1 focus:ring-white/50 transition-all font-['Space_Grotesk']"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-4 py-3.5 text-white placeholder-slate-500 focus:outline-none focus:border-white/70 focus:ring-1 focus:ring-white/70 transition-all font-['Space_Grotesk']"
          ...
          <div className="mt-8 text-center text-slate-400 text-sm">
            ...
            <Link to="/login" className="text-white hover:text-white font-bold transition-colors">
              Sign In
            </Link>
          </div>
        </div>
